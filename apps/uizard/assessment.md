...
**App Version/Plan:** Free/Pro/Enterprise (AI UI Design Tool)  

---

## Document Sources

- **Terms of Service:** Unable to access (Accessed: 2026-03-26)
- **Privacy Policy:** Unable to access (Accessed: 2026-03-26)
- **Status:** Manual research required
- **Website:** https://uizard.io/

---

## ⚠️ ASSESSMENT PENDING - MANUAL RESEARCH REQUIRED

**Issue:** Unable to access Uizard's legal documents via automated methods.

**To Complete This Assessment:**

1. Visit https://uizard.io/
2. Navigate to:
...
4. Save to `apps/uizard/legal-docs/`
...
- Converts sketches, text prompts, and screenshots to mockups
- Exports to React, HTML, or design files
- Free tier available
...
- Does Uizard train AI on user uploads?
- Can users opt out of training?
- What happens to sketches/screenshots after processing?

#### IP Ownership
- Who owns generated designs?
- Can Uizard use designs for marketing?
...
2. **Find and download:**
   ...
   - Privacy Policy
   - Cookie Policy (if separate)
   - Any AI-specific terms
3. **Save to:** `apps/uizard/legal-docs/`
4. **Complete assessment rubric above**
...
**Uizard Support:**
- Website: https://uizard.io/
- Email: Look for support contact on website
- Documentation: Check for help center or docs
